package edu.eci.cvds.component;
...
import edu.eci.cvds.repository.AdministracionRepository;
import edu.eci.cvds.service.AdministracionService;
...
public class AdministracionBean implements Serializable{
    ...
    public String agregarConsulta(){
        ...
        return "index2.xhtml?faces-redirect=true&includeViewParams=true";
    }
}